	...
	jQuery(document).ready(function () {
		if($('.slider-background').length > 0){
			 $.backstretch([
				  "bg4.jpg"/*tpa=http://bootstrapwizard.info/Theme/FullscreenV4/js/img/bg4.jpg*/
				, "bg5-1.jpg"/*tpa=http://bootstrapwizard.info/Theme/FullscreenV4/js/img/bg5.jpg*/
				, "bg2-1.jpg"/*tpa=http://bootstrapwizard.info/Theme/FullscreenV4/js/img/bg2.jpg*/
	...
	$(document).ready(function() {
		if($('#slider').length > 0){	
			...
			$(".next").click(function(){
				owl.trigger('http://bootstrapwizard.info/Theme/FullscreenV4/js/owl.next');
			})
			$(".prev").click(function(){
				owl.trigger('http://bootstrapwizard.info/Theme/FullscreenV4/js/owl.prev');
			})
		}
...
$(document).ready(function() {	
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                url: "http://bootstrapwizard.info/Theme/FullscreenV4/js/contact-process.php",
                type: "POST",
                data: {
                    name: name,
                    email: email,
